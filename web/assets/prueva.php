            ...
            <div class="content">
                <div class="incidents-table-container">
                    <table id="incidentsTable" class="display">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT id, fecha, hora, ubicacion, tipo, severidad, estado FROM incidentes ORDER BY fecha DESC";
                            $resultado = mysqli_query($conn, $sql);
                            ...
                            if (!$resultado) {
                                ...
                                while ($fila = mysqli_fetch_assoc($resultado)) {
                                    // Clases para colores segun severidad y estado
                                    $sevClass = '';
                                ...
                                echo '<tr><td colspan="6">No hay incidentes registrados.</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
